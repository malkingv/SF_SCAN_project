                    ...
                    state.resultDocs.map(elem =>
                        <div className={'card'} key={elem.ok.id}>
                            <div className={'card-head'}>
                                <div className={'date'}>{new Date(elem.ok.issueDate).toLocaleDateString('en-GB').replaceAll('/', '.')}</div>
                                <div className={'source'}>{elem.ok.source.name}</div>
                            </div>
                            <div className={'card-name'}>
                              <a href={elem.ok.url} target="_blank">{elem.ok.title.text}</a>
                            </div>
