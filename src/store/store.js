...
import {INFO_USER, LOGIN_USER, LOGOUT_USER, RESET_RESULT, RESULT_DOC, RESULT_HISTOGRAM, RESULT_ID, SCREEN_SIZE, SEARCH_DATA} from "./types";
...
const reducer = (state = intitialState, action) => {
    switch (action.type) {
        ...
        case RESULT_DOC:
            return { ...state,
            resultDocs: state.resultDocs ? state.resultDocs.concat(action.payload) : action.payload
        }
        case RESET_RESULT:
            return { ...state,
